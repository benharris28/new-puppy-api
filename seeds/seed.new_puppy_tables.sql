...
TRUNCATE
  ...
  VALUES
    ...
    VALUES
    ("Farmer's Dog", "Fresh Food Subscription", "Fresh Food", "https://www.thefarmersdog.com/images/recipes-slideshow-1-b2b8ec.webp", 4.8, 1000, "$500 per month (estimate)", "$300 per month (estimate)", "$150 per month (estimate)", "Subscribe to Farmer's Dog", "Gently cooked meals that are flash frozen and delivered directly to your door. This is the healthiest food available, but at higher price point than Kibble", "https://www.thefarmersdog.com/"),
    ("Stella & Chewy's", "Cage-Free Chicken Raw Coated Kibble for Puppies", "Premium Kibble", "https://www.stellaandchewys.com/wp-content/uploads/RC-3.5LB-Chicken-Puppy.jpg", 4.8, 1000, "$150 (estimated)", "$100 (estimated)", "$70 (estimated)", "Find Stella & Chewy's", "High quality ingredients with chunks of freeze-dried raw meat. Dogs love it and its healthier than most kibble options", "https://www.stellaandchewys.com/");
